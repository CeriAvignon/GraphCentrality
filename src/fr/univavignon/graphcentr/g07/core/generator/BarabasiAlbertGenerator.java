package fr.univavignon.graphcentr.g07.generator.BarabasiAlbert;
...
public class BarabasiAlbertGenerator
{
	 ...
	 * @return SimpleGraph
	 */
	public SimpleGraph generate(int nodeCount, int degree)
	{
		...
		for (int i = 0; i < nodeCount; i++)
		{
			...
			for (int j = 0; j < degree; j++)
			{
				...
				if (probaList.size() > 0)
				{
					...
					int randomIndex = ThreadLocalRandom.current().nextInt(0, probaList.size()-1);
