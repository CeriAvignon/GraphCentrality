 ...
 * 
 * @brief Directed graph of spatial node & weighted link
 */
public class DirectedSpatialWeightedGraph extends AbstractDirectedGraph<SpatialNode, WeightedLink> 
{
	/** Weighted graph helper to compute matrices etc... */
	private WeightedGraphHelper<AbstractDirectedGraph<SpatialNode, WeightedLink>, SpatialNode> weightedGraphHelper;
	/** Spatial graph helper to compute euclidean distance etc... */
	private SpatialGraphHelper<AbstractDirectedGraph<SpatialNode, WeightedLink>, WeightedLink> spatialGraphHelper;
	
	/**
	 * Default constructor
	 */
	public DirectedSpatialWeightedGraph()
	{
		super();
