...
import fr.univavignon.graphcentr.g01.CliqueTreeSet;
 ...
 *
 */
public class CliqueTreeSetTest {
	
	/**
	 * Execute Clique (with TreeSet) Test 
	 */
	public static void execute()
	{
		...
		CliqueTreeSet centrality = new CliqueTreeSet();
